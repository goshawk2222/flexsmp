        ...
        if ((!team.name.isEmpty() ||
            ...
            tEl.click(function(){
                ...
                function team_selector(){
                    div.siblings('div.team').find('div.score').text("0");
                    var span = div.find('div.score');
                    span.text("1");
                    //////////
                    // var val = input.val();
                    ...
                    // span.html(val);
                    // if (isNumber(val)) {
                        team.score = Score.of(parseInt(span.text(), 10));
                        team.sibling().score = Score.of(parseInt("0", 10));
                        renderAll(true);
                    // }
                    // span.click(editor);
                    ////////////
